...
<!-- ========================
        Team layout 2
    ========================== -->
<section class="team-layout2 pb-40" id="doctor-section">
    <div class="container">
        <div class="row">
            <!-- Member #1 -->
            ...
            <div class="member">
                ...
                <div class="member">
                    ...
                    <div class="member__info">
                        <h5 class="member__name"><a href="doctors-single-doctor1.html">Dr Zameera</a></h5>
                        <p class="member__job">5.00 pm to 8.00 pm </p>
                        <p class="member__job">Cell no: 2135467988</p>
                        <p class="member__job">Practicing At : KLE Belgaum</p>
                    </div>
                    <!-- /.member-info -->
