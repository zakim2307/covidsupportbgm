    ...
    <section class="slider">
        <div class="slick-carousel m-slides-0"
            ...
            <div class="slide-item align-v-h">
                <div class="bg-img"><img src="assets/images/sliders/main.jpeg" alt="slide img"></div>
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-sm-12 col-md-12 col-lg-12 col-xl-7">
                            <div class="slide__content">
                                <h2 class="slide__title">Providing Best Covid Care</h2>
                                ...
                                <ul class="features-list list-unstyled mb-0 d-flex flex-wrap">
                                    ...
                                    <li class="feature-item">
                                        <div class="feature__icon">
                                            <a href="testingCenter.php">
                                                <i class="icon-heart"></i>
                                            </a>
                                        </div>
                                        <h2 class="feature__title">COVID Checkup</h2>
                                    </li><!-- /.feature-item-->
                                    <!-- feature item #2 -->
                                    <li class="feature-item">
                                        <div class="feature__icon">
                                        ...
                                        <h2 class="feature__title"> Ambulance </h2>
                                    </li><!-- /.feature-item-->
                                    <!-- feature item #3 -->
                                    <li class="feature-item">
                                        <div class="feature__icon">
                                        ...
                                        <h2 class="feature__title">Donations</h2>
                                    </li><!-- /.feature-item-->
                                    <!-- feature item #4 -->
                                    <li class="feature-item">
                                        <div class="feature__icon">
                                        ...
                                        <h2 class="feature__title">Plasma Therapy</h2>
                                    </li><!-- /.feature-item-->
                                </ul><!-- /.features-list -->
                            </div><!-- /.slide-content -->
                        </div><!-- /.col-xl-7 -->
    ...
    <!-- ======================
     Work Process 
    ========================= -->
    <section class="work-process work-process-carousel pt-130 pb-0 bg-overlay bg-overlay-secondary mt-50">
        <div class="bg-img"><img src="assets/images/banners/1.jpg" alt="background"></div>
        <div class="container">
            <div class="row heading-layout2">
                <div class="col-12">
                    <h2 class="heading__subtitle color-primary">Caring For The Health Of You And Your Family.
                    </h2>
                </div><!-- /.col-12 -->
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-5">
                    <h3 class="heading__title color-white">We Provide All Aspects Of Medical Practice For Your
                        Whole
                        Family!
                    </h3>
                </div><!-- /.col-xl-5 -->
                <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 offset-xl-1">
                    ...
                    <ul class="list-items list-items-layout2 list-items-light list-horizontal list-unstyled">
                        <li>Donations For Poor Patients</li>
                        <li>COVID-19 Free Testing Centers</li>
                        <li>Bed Availability</li>
                        <li>List of Qaulified Doctors</li>
                    </ul>
                </div><!-- /.col-xl-6 -->
            </div><!-- /.row -->
            <div class="row">
                    ...
                    <div class="carousel-container mt-90">
                        <div class="slick-carousel"
                            ...
                            <div class="process-item">
                                ...
                                <p class="process__desc">Get All the free Testing centers Provided By NGOs, HOspitals,
                                    Doctors, individuals</p>
                                <a href="testingCenter.php" class="btn btn__secondary btn__link">
                            ...
                            <div class="process-item">
                                ...
                                <h4 class="process__title">List of Qaulified Doctors and Medical Experts</h4>
                                <p class="process__desc">Find out the list of doctors providing services of Novel
                                    Covid-19 </p>
                                <a href="doctor.php" class="btn btn__secondary btn__link">
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-12 col-md-3 col-lg-3">
                        <a href="#services" class="btn btn__primary btn__secondary-style2 btn__rounded">
    ...
    Features Layout 2
    ========================= -->
    <section class="features-layout2 pt-130" id='services'>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-1">
                    <div class="heading__layout2 mb-50">
                        <h3 class="heading__title">COVID Support Belgaum Has Touched The Lives Of Patients &
                            Providing
                            Care for The
                            COVID Affected In Our Community.</h3>
                    </div>
                </div><!-- /col-lg-5 -->
            </div><!-- /.row -->
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="feature-item">
                        ...
                        <div class="feature__content">
                            ...
                            <h4 class="feature__title">Angels - Ambulance Service
                                <br />
                            </h4>
                        </div><!-- /.feature__content -->
            ...
            <div class="row">
                <div class="col-md-12 col-lg-6 offset-lg-3 text-center">
                    <p class="font-weight-bold color-gray mb-0">We hope you will allow us to care for you and strive to
                        be the
                ...
                <div class="col-sm-12 col-md-12 col-lg-7">
                    <div class="contact-panel mb-50">
                        <form class="contact-panel__form" method="post" action="assets/php/contact.php"
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <h4 class="contact-panel__title">Request Query</h4>
                                    <p class="contact-panel__desc mb-30">Please feel welcome to contact our
                                        friendly
                                        reception staff
                                        with any general or medical enquiry. Our doctors will receive or return
                                        any
                                        urgent calls.
                                    </p>
                                </div>
                                ...
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group form-group-date">
                                        ...
                                        <input type="date" class="form-control" id="query-date" name="contact-date"
                                            required>
                                    </div>
                                </div><!-- /.col-lg-4 -->
                                <div class="col-sm-4 col-md-4 col-lg-4">
                                    <div class="form-group form-group-date">
                                        ...
                                        <input type="time" class="form-control" id="query-time" name="contact-time"
                                            required>
                                    </div>
                                </div><!-- /.col-lg-4 -->
                                <div class="col-12">
                ...
                <div class="col-sm-12 col-md-12 col-lg-5">
                    ...
                    <div class="d-flex align-items-center">
                        <a href="donation.php" class="btn btn__white btn__rounded mr-30">
                            <i class="fas fa-heart"></i> <span>Give A Gift</span>
                        </a>
                        <a class="video__btn video__btn-white popup-video" href="informationVideo.php">
                            <div class="video__player">
                                <i class="fa fa-play"></i>
                            </div>
                            <span class="video__btn-title color-white">Inspirational Work</span>
                        </a>
                    </div>
