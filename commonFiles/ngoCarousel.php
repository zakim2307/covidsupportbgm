      ...
      <div class="container">
              ...
              <div class="slick-carousel carousel-arrows-light carousel-dots-light"
                ...
                <div class="service-item">
                  <div class="service__img">
                    <img src="assets/images/clients/1.png" alt="img" loading="lazy">
                  </div><!-- /.service__img -->
                  <div class="service__content">
                    <h4 class="service__title">AL IQRA</h4>
                    <p class="service__desc">Humanity in Human Being</p>
                ...
                <div class="service-item">
                  ...
                  <div class="service__content">
                    <h4 class="service__title">Human Foundation</h4>
                    <p class="service__desc">Humanity in Human Being</p>
                ...
                <div class="service-item">
                  ...
                  <div class="service__content">
                    <h4 class="service__title">Rehbar Foundation</h4>
                    <p class="service__desc">Humanity in Human Being</p>
                ...
                <div class="service-item">
                  ...
                  <div class="service__content">
                    <h4 class="service__title">AL HAYAT</h4>
                    <p class="service__desc">Humanity in Human Being</p>
                ...
                <div class="service-item">
                  ...
                  <div class="service__content">
                    <h4 class="service__title">Mercy Mission</h4>
                    <p class="service__desc">Humanity in Human Being</p>
                ...
                <div class="service-item">
                  ...
                  <div class="service__content">
                    <h4 class="service__title">Peace Foundation</h4>
                    <p class="service__desc">Humanity in Human Being
                    </p>
        ...
        <div class="row">
          <div class="col-12 d-flex justify-content-end mt-20">
            <a href="volunteerRegister" class="btn btn__white btn__rounded ml-30" style="align-items: center;">
