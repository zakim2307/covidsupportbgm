        ...
        <div class="row">
            <div class="col-12">
                <div class="contact-panel d-flex flex-wrap">
                    ...
                    <form class="contact-panel__form margin_left_form" method="post" action="assets/php/contact
                        id="contactForm" style="padding-right:0px;padding-left:70px;">
                        <div class="row">
                            <div class="col-sm-12">
                                <h4 class="contact-panel__title">We Appreciate the Help of our Volunteers </h4>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Name" id="volunteer-name"
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone" id="volunteer-Phone"
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Address" id="volunteer-address"
                                        name="contact-phone" required>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" placeholder="Message" id="volunteer-message"
